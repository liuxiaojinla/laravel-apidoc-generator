...
namespace Xin\ApiDoc\Extracting\Strategies\Metadata;
...
use Xin\ApiDoc\Extracting\RouteDocBlocker;
...
class GetFromDocBlocks extends Strategy{
	...
	public function __invoke(Route $route, ReflectionClass $controller, ReflectionMethod $method, array $routeRules, array $context = []){
		...
		[
			$routeGroupName, $routeGroupDescription, $routeTitle,
		] = $this->getRouteGroupDescriptionAndTitle($methodDocBlock, $classDocBlock);

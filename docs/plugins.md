...
## Strategies
To create a strategy, create a class that extends `\Xin\ApiDoc\Extracting\Strategies\Strategy`.
...
...
    'strategies' => [
        'metadata' => [
            \Xin\ApiDoc\Extracting\Strategies\Metadata\GetFromDocBlocks::class,
        ],
        'urlParameters' => [
            \Xin\ApiDoc\Extracting\Strategies\UrlParameters\GetFromUrlParamTag::class,
        ],
        'queryParameters' => [
            \Xin\ApiDoc\Extracting\Strategies\QueryParameters\GetFromQueryParamTag::class,
        ],
        'headers' => [
            \Xin\ApiDoc\Extracting\Strategies\RequestHeaders\GetFromRouteRules::class,
        ],
        'bodyParameters' => [
            \Xin\ApiDoc\Extracting\Strategies\BodyParameters\GetFromBodyParamTag::class,
        ],
        'responses' => [
            \Xin\ApiDoc\Extracting\Strategies\Responses\UseTransformerTags::class,
            \Xin\ApiDoc\Extracting\Strategies\Responses\UseResponseTag::class,
            \Xin\ApiDoc\Extracting\Strategies\Responses\UseResponseFileTag::class,
            \Xin\ApiDoc\Extracting\Strategies\Responses\UseApiResourceTags::class,
            \Xin\ApiDoc\Extracting\Strategies\Responses\ResponseCalls::class,
        ],
    ],
...
```

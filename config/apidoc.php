...
return [
	...
	/*
	 * You can choose one or more generators
	 */
	'channels'      => [
		'postman',
	],
	...
	/*
	 * You can provide multiple writers
	 */
	'writers'       => [
		...
		'postman' => [
			 ...
			 * - 0 will generate a static json file in the /public/docs folder,
			 * - 1 will generate the storage json file in the /apidoc folder,
		...
		[
			...
			'apply'   => [
				...
				'response_calls' => [
					 ...
					 */
					'queryParams' => [
						'access_id' => '0ca66c077c1938f7c2ed1042fa423b33',
					],
				...
				'default_response' => '{"code":1,"msg":"OK","data":[]}',
			],
		],
	],
	 ...
	 *
	 */
	'routeMatcher'      => \Xin\ApiDoc\Matching\RouteMatcher::class,
];
